...
const Card = ({quiz , type , editHandle , handleDelete } : 
  {quiz : IQuiz , type : string , editHandle? : any ,handleDelete? : any }) => {
            ...
            (
              <div className="mt-2 relative flex flex-row justify-between items-center">
                ...
                <div onClick={editHandle}>
                  <button className="mt-4 ml-2 w-[130px] h-[40px] text-xl
                ...
                <div onClick={handleDelete} className="cursor-pointer text-3xl mt-3 hover:scale-110 
