        ...
        <div className='absolute w-full z-10'>
          <div className=' w-[80%] text-3xl items-center bg-black mx-auto h-[50px] mt-5 rounded-[15px] text-white flex justify-between p-8'>
            ...
            <div className='flex items-center gap-4'>
              ...
              <div onClick={() => setLogoutmodal(true)} className='cursor-pointer hover:scale-125 hover:text-red-600 hover:translate-x-3 transition-all ease-in-out duration-300' >
                <FiLogOut /> 
              </div>
            </div>
          </div>
